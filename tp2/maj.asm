...
convert_loop:
    ...
    jb not_lowercase ;si AL < 'a', ce n'est pas une minuscule
    cmp al, 'z' ;verifier si AL <= 'z'
    ja not_lowercase ;si AL > 'z', ce n'est pas une minuscule
    and al, 11011111b ;mettre le 6e bit a 0 pour convertir en majuscule
not_lowercase:
