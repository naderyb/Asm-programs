;programme 10: faire la multiplication en 16bits (bit signes)
...
code segment
    ...
    imul bx ;multiplier (avec retenue) la valeur qui est dans bx par la valeur de a qui dans l'accumulateur
