;programme 8: faire la soustraction en 32bits

data segment
    a_high dw 2345h ;partie haute de a
    a_low dw 0762h ;partie basse de a
...
code segment
    ...
    begin: 
        ...
        sbb ax, b_low ;ajouter la valeur de b a la valeur charger dans ax soit de a
        mov c, axcharger la valeur de ax danx c
        mov ax, a_high ;chrager la valeur de la partie haute de a dans ax
        sub ax, b_high ;ajouter la valeur de ax a bx
